...
//    private lateinit var changePasswordButton:
        ...
        changePasswordButton.setOnClickListener() {
            if (isValidPassword(passwordEditText.text.toString())) {
                if (passwordCheckEditText.text.toString() == passwordEditText.text.toString()) {
                    ...
                    val newUserData = UserRegister(oldUserData.username, passwordEditText.text.toString(),oldUserData.firstName ,oldUserData.lastName, oldUserData.phoneNumber, oldUserData.email)
